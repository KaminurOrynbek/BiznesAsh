...
type CreatePostRequest struct {
	...
	Type          PostType               `protobuf:"varint,3,opt,name=type,proto3,enum=content.PostType" json:"type,omitempty"`
...
const file_content_content_proto_rawDesc = "" +
	"\n" +
	"\x15content/content.proto\x12\acontent\"\xae\x02\n" +
	"\x04Post\x12\x0e\n" +
	...
	"\ais_like\x18\x04 \x01(\bR\x06isLike\x12\x1d\n" +
	"\n" +
	"created_at\x18\x05 \x01(\tR\tcreatedAt\"\xa5\x01\n" +
	"\x11CreatePostRequest\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x12%\n" +
	"\x04type\x18\x03 \x01(\x0e2\x11.content.PostTypeR\x04type\x12\x1b\n" +
	"\tauthor_id\x18\x04 \x01(\tR\bauthorId\x12\x1c\n" +
	"\tpublished\x18\x05 \x01(\bR\tpublished\"q\n" +
	"\x11UpdatePostRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x18\n" +
	"\acontent\x18\x03 \x01(\tR\acontent\x12\x1c\n" +
	"\tpublished\x18\x04 \x01(\bR\tpublished\"\x1f\n" +
	...
	"\x12DislikePostRequest\x12\x17\n" +
	"\apost_id\x18\x01 \x01(\tR\x06postId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\"3\n" +
	"\x10LikePostResponse\x12\x1f\n" +
	"\vlikes_count\x18\x01 \x01(\x05R\n" +
	"likesCount\"<\n" +
	"\x13DislikePostResponse\x12%\n" +
	"\x0edislikes_count\x18\x01 \x01(\x05R\rdislikesCount*%\n" +
	"\bPostType\x12\x0e\n" +
	"\n" +
	"LEGAL_INFO\x10\x00\x12\t\n" +
	"\x05GUIDE\x10\x012\xc2\x06\n" +
	...
	"\rDeleteComment\x12\x19.content.CommentIdRequest\x1a\x17.content.DeleteResponse\x12E\n" +
	"\fListComments\x12\x16.content.PostIdRequest\x1a\x1d.content.ListCommentsResponse\x12?\n" +
	"\bLikePost\x12\x18.content.LikePostRequest\x1a\x19.content.LikePostResponse\x12H\n" +
	"\vDislikePost\x12\x1b.content.DislikePostRequest\x1a\x1c.content.DislikePostResponseB?Z=github.com/KaminurOrynbek/BiznesAsh/ContentService/auto-protob\x06proto3"
...
var file_content_content_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_content_content_proto_goTypes = []any{
	...
	(*DislikePostRequest)(nil),   // 18: content.DislikePostRequest
	(*LikePostResponse)(nil),     // 19: content.LikePostResponse
	(*DislikePostResponse)(nil),  // 20: content.DislikePostResponse
}
var file_content_content_proto_depIdxs = []int32{
	0,  // 0: content.Post.type:type_name -> content.PostType
	0,  // 1: content.CreatePostRequest.type:type_name -> content.PostType
	0,  // 2: content.ListPostsRequest.type:type_name -> content.PostType
	1,  // 3: content.PostResponse.post:type_name -> content.Post
	1,  // 4: content.ListPostsResponse.posts:type_name -> content.Post
	2,  // 5: content.CommentResponse.comment:type_name -> content.Comment
	2,  // 6: content.ListCommentsResponse.comments:type_name -> content.Comment
	4,  // 7: content.ContentService.CreatePost:input_type -> content.CreatePostRequest
	5,  // 8: content.ContentService.UpdatePost:input_type -> content.UpdatePostRequest
	6,  // 9: content.ContentService.DeletePost:input_type -> content.PostIdRequest
	6,  // 10: content.ContentService.GetPost:input_type -> content.PostIdRequest
	7,  // 11: content.ContentService.ListPosts:input_type -> content.ListPostsRequest
	8,  // 12: content.ContentService.SearchPosts:input_type -> content.SearchPostsRequest
	12, // 13: content.ContentService.CreateComment:input_type -> content.CreateCommentRequest
	13, // 14: content.ContentService.UpdateComment:input_type -> content.UpdateCommentRequest
	14, // 15: content.ContentService.DeleteComment:input_type -> content.CommentIdRequest
	6,  // 16: content.ContentService.ListComments:input_type -> content.PostIdRequest
	17, // 17: content.ContentService.LikePost:input_type -> content.LikePostRequest
	18, // 18: content.ContentService.DislikePost:input_type -> content.DislikePostRequest
	9,  // 19: content.ContentService.CreatePost:output_type -> content.PostResponse
	9,  // 20: content.ContentService.UpdatePost:output_type -> content.PostResponse
	11, // 21: content.ContentService.DeletePost:output_type -> content.DeleteResponse
	9,  // 22: content.ContentService.GetPost:output_type -> content.PostResponse
	10, // 23: content.ContentService.ListPosts:output_type -> content.ListPostsResponse
	10, // 24: content.ContentService.SearchPosts:output_type -> content.ListPostsResponse
	15, // 25: content.ContentService.CreateComment:output_type -> content.CommentResponse
	15, // 26: content.ContentService.UpdateComment:output_type -> content.CommentResponse
	11, // 27: content.ContentService.DeleteComment:output_type -> content.DeleteResponse
	16, // 28: content.ContentService.ListComments:output_type -> content.ListCommentsResponse
	19, // 29: content.ContentService.LikePost:output_type -> content.LikePostResponse
	20, // 30: content.ContentService.DislikePost:output_type -> content.DislikePostResponse
