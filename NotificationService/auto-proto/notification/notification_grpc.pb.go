...
const (
	...
	NotificationService_VerifyEmail_FullMethodName             = "/notification.NotificationService/VerifyEmail"
	...
	NotificationService_ResendVerificationCode_FullMethodName  = "/notification.NotificationService/ResendVerificationCode"
)
...
func (c *notificationServiceClient) ResendVerificationCode(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*NotificationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NotificationResponse)
	err := c.cc.Invoke(ctx, NotificationService_ResendVerificationCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NotificationService_ResendVerificationCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_ResendVerificationCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
